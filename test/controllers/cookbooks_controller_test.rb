...
class CookbooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cookbook" do
    assert_difference('Cookbook.count') do
      post cookbooks_url, params: { cookbook: { description: @cookbook.description, int: @cookbook.int, name: @cookbook.name, serving: @cookbook.serving, text: @cookbook.text, time: @cookbook.time } }
    end
  ...
  test "should update cookbook" do
    patch cookbook_url(@cookbook), params: { cookbook: { description: @cookbook.description, int: @cookbook.int, name: @cookbook.name, serving: @cookbook.serving, text: @cookbook.text, time: @cookbook.time } }
